...
'31321212' => 'Hardwood and softwood veneer and plywood',
'31321214' => 'All other plywood and engineered wood products',
...
'31332721' => 'Precision turned products',
'31332722' => 'Bolts, nuts, screws, rivets, and washers',
...
'31333111' => 'Farm machinery and equipment',
...
'31334111' => 'Electronic computers',
'31334118' => 'Computer storage devices, terminals, and other peripheral equipment',
'31334200' => 'Communications equipment',
'31334210' => 'Telephone apparatus',
...
'31335312' => 'Motors and generators',
'31335313' => 'Switchgear and switchboard apparatus',
'31335314' => 'Relays and industrial controls',
...
'31336110' => 'Automobiles and light trucks',
'31336111' => 'Automobiles',
'31336112' => 'Light trucks and utility vehicles',
'31336120' => 'Heavy duty trucks',
...
'31336340' => 'Motor vehicle brake systems',
...
'31337212' => 'Wood office furniture and custom architectural woodwork and millwork',
'31337214' => 'Office furniture, except wood',
...
'32313210' => 'Broadwoven fabric mills',
'32313300' => 'Textile and fabric finishing mills',
...
'32315000' => 'Apparel',
'32315200' => 'Cut and sew apparel',
'32315210' => 'Cut and sew apparel contractors',
'32315280' => 'Cut and sew apparel, except contractors',
'32315900' => 'All other apparel manufacturing',
...
'32323110' => 'Printing',
'32323113' => 'Commercial screen printing',
'32323117' => 'Commercial printing, except screen',
'32323120' => 'Support activities for printing',
...
'32329200' => 'Tobacco and tobacco products',
'32329300' => 'Leather and allied products',
...
'41424330' => 'Womens and childrens clothing',
...
'42448110' => 'Mens clothing stores',
'42448120' => 'Womens clothing stores',
'42448130' => 'Childrens and infants clothing stores',
...
'42452100' => 'Department stores',
'42452111' => 'Department stores, except discount',
'42452112' => 'Discount department stores',
'42452900' => 'Other general merchandise stores',
'42452910' => 'Warehouse clubs and supercenters',
'42452990' => 'All other general merchandise stores',
...
'42454112' => 'Electronic shopping and electronic auctions',
'42454113' => 'Mail-order houses',
...
'50511140' => 'Directory and mailing list publishers',
'50511190' => 'Other publishers',
...
'50517100' => 'Wired telecommunications carriers',
'50517200' => 'Wireless telecommunications carriers (except satellite)',
...
'55532230' => 'Video tape and disc rental',
'55532290' => 'Miscellaneous consumer goods rental',
'55532291' => 'Home health equipment rental',
...
'60541191' => 'Title abstract and settlement offices',
...
'60541711' => 'Biotechnology research',
'60541712' => 'Physical, engineering, and life sciences research',
...
'60561450' => 'Credit bureaus',
'60561490' => 'Other business support services',
...
'65623220' => 'Residential mental health and substance abuse facilites',
...
'70721211' => 'RV parks and campgrounds',
'70721214' => 'Recreational and vacation camps',
...
'90932999' => 'Other local government'
  ...
  def unit(datatype)
    case datatype
    when '01' #ALL EMPLOYEES, THOUSANDS
      unit_by_internal_name['jobs-or-employees'].id
    when '02' #AVERAGE WEEKLY HOURS OF ALL EMPLOYEES
      unit_by_internal_name['hours'].id
    when '03' #03  AVERAGE HOURLY EARNINGS OF ALL EMPLOYEES
      unit_by_internal_name['nominal-us-dollars'].id
    when '04' #04  AVERAGE WEEKLY OVERTIME HOURS OF ALL EMPLOYEES
      unit_by_internal_name['hours'].id
    when '06' #06  PRODUCTION AND NONSUPERVISORY EMPLOYEES, THOUSANDS
      unit_by_internal_name['jobs-or-employees'].id
    when '07' #07  AVERAGE WEEKLY HOURS OF PRODUCTION AND NONSUPERVISORY EMPLOYEES
      unit_by_internal_name['hours'].id
    when '08' #08  AVERAGE HOURLY EARNINGS OF PRODUCTION AND NONSUPERVISORY EMPLOYEES
      unit_by_internal_name['nominal-us-dollars'].id
    when '09' #09  AVERAGE WEEKLY OVERTIME HOURS OF PRODUCTION AND NONSUPERVISORY EMPLOYEES
      unit_by_internal_name['hours'].id
    when '10' #10  WOMEN EMPLOYEES, THOUSANDS
      unit_by_internal_name['jobs-or-employees'].id
    when '11' #11  AVERAGE WEEKLY EARNINGS OF ALL EMPLOYEES
      unit_by_internal_name['nominal-us-dollars'].id
    when '12' #12  AVERAGE WEEKLY EARNINGS OF ALL EMPLOYEES, 1982-1984 DOLLARS
      unit_by_internal_name['real-us-dollars'].id
    when '13' #13  AVERAGE HOURLY EARNINGS OF ALL EMPLOYEES, 1982-1984 DOLLARS
      unit_by_internal_name['real-us-dollars'].id
    when '15' #15  AVERAGE HOURLY EARNINGS OF ALL EMPLOYEES, EXCLUDING OVERTIME
      unit_by_internal_name['nominal-us-dollars'].id
    when '16' #16  INDEXES OF AGGREGATE WEEKLY HOURS OF ALL EMPLOYEES, 2007=100
      unit_by_internal_name['indexes'].id
    when '17' #17  INDEXES OF AGGREGATE WEEKLY PAYROLLS OF ALL EMPLOYEES, 2007=100
      unit_by_internal_name['indexes'].id
    when '19' #19  AVERAGE WEEKLY HOURS OF ALL EMPLOYEES, QUARTERLY AVERAGES, SEASONALLY ADJUSTED
      unit_by_internal_name['hours'].id
    when '20' #20  AVERAGE WEEKLY OVERTIME HOURS OF ALL EMPLOYEES, QUARTERLY AVERAGES, SEASONALLY ADJUSTED
      unit_by_internal_name['hours'].id
    when '21' #21  DIFFUSION INDEXES, 1-MONTH SPAN, SEASONALLY ADJUSTED
      unit_by_internal_name['indexes'].id
    when '22' #22  DIFFUSION INDEXES, 3-MONTH SPAN, SEASONALLY ADJUSTED
      unit_by_internal_name['indexes'].id
    when '23' #23  DIFFUSION INDEXES, 6-MONTH SPAN, SEASONALLY ADJUSTED
      unit_by_internal_name['indexes'].id
    when '24' #24  DIFFUSION INDEXES, 12-MONTH SPAN, NOT SEASONALLY ADJUSTED
      unit_by_internal_name['indexes'].id
    when '25' #25  ALL EMPLOYEES, QUARTERLY AVERAGES, SEASONALLY ADJUSTED, THOUSANDS
      unit_by_internal_name['jobs-or-employees'].id
    when '26' #26  ALL EMPLOYEES, 3-MONTH AVERAGE CHANGE, SEASONALLY ADJUSTED, THOUSANDS
      unit_by_internal_name['percent'].id
    when '30' #30  AVERAGE WEEKLY EARNINGS OF PRODUCTION AND NONSUPERVISORY EMPLOYEES
      unit_by_internal_name['nominal-us-dollars'].id
    when '31' #31  AVERAGE WEEKLY EARNINGS OF PRODUCTION AND NONSUPERVISORY EMPLOYEES, 1982-84 DOLLARS
      unit_by_internal_name['real-us-dollars'].id
    when '32' #32  AVERAGE HOURLY EARNINGS OF PRODUCTION AND NONSUPERVISORY EMPLOYEES, 1982-84 DOLLARS
      unit_by_internal_name['real-us-dollars'].id
    when '33' #33  AVERAGE HOURLY EARNINGS OF PRODUCTION AND NONSUPERVISORY EMPLOYEES, EXCLUDING OVERTIME
      unit_by_internal_name['nominal-us-dollars'].id
    when '34' #34  INDEXES OF AGGREGATE WEEKLY HOURS OF PRODUCTION AND NONSUPERVISORY EMPLOYEES, 2002=100
      unit_by_internal_name['indexes'].id
    when '35' #35  INDEXES OF AGGREGATE WEEKLY PAYROLLS OF PRODUCTION AND NONSUPERVISORY EMPLOYEES, 2002=100
      unit_by_internal_name['indexes'].id
    when '36' #36  AVERAGE WEEKLY HOURS, PRODUCTION/NONSUPERVISORY EMPLOYEES, QUARTERLY AVERAGES, SEASONALLY ADJUSTED
      unit_by_internal_name['hours'].id
    when '37' #37  AVERAGE WEEKLY OVERTIME HOURS,PRODUCTION/NONSUPERVISORY EMPLOYEES,QUARTERLY AVG,SEASONALLY ADJUSTED
      unit_by_internal_name['hours'].id
    when '38' #38  PRODUCTION AND NONSUPERVISORY EMPLOYEES-TO-ALL EMPLOYEES RATIO
      unit_by_internal_name['ratios'].id
    when '39' #39  WOMEN EMPLOYEES-TO-ALL EMPLOYEES RATIO
      unit_by_internal_name['ratios'].id
    when '56' #56  AGGREGATE WEEKLY HOURS OF ALL EMPLOYEES, THOUSANDS
      unit_by_internal_name['hours'].id
    when '57' #57  AGGREGATE WEEKLY PAYROLLS OF ALL EMPLOYEES, THOUSANDS
      unit_by_internal_name['jobs-or-employees'].id
    when '58' #58  AGGREGATE WEEKLY OVERTIME HOURS OF ALL EMPLOYEES, THOUSANDS
      unit_by_internal_name['hours'].id
    when '81' #81  AGGREGATE WEEKLY HOURS OF PRODUCTION AND NONSUPERVISORY EMPLOYEES, THOUSANDS
      unit_by_internal_name['hours'].id
    when '82' #82  AGGREGATE WEEKLY PAYROLLS OF PRODUCTION AND NONSUPERVISORY EMPLOYEES, THOUSANDS
      unit_by_internal_name['jobs-or-employees'].id
    when '83' #83  AGGREGATE WEEKLY OVERTIME HOURS OF PRODUCTION AND NONSUPERVISORY EMPLOYEES, THOUSANDS
      unit_by_internal_name['hours'].id
    when '98' #98  CPI-U 1982-84
      unit_by_internal_name['indexes'].id
    when '99' #99  CPI-W 1982-84
      unit_by_internal_name['indexes'].id
    end
  end
  ...
  def industry_id(industrycode)
    case industrycode
    when '0' #Total nonfarm
      industry_by_internal_name['all-industries'].id
    when '00000000'
      industry_by_internal_name['all-industries'].id
    when '05000000' #Total private
      industry_by_internal_name['all-private-industry'].id
    when '06000000' #Goods-producing
      industry_by_internal_name['all-goods-producers'].id
    when '07000000' #Service-providing
      industry_by_internal_name['all-service-providers'].id
    when '08000000' #Private service-providing
      industry_by_internal_name['private-service-providers'].id
    when '10000000' #Mining and logging
      industry_by_internal_name['mining-quarrying-and-oil-and-gas-extraction'].id
    when '30000000' #Manufacturing
      industry_by_internal_name['manufacturing'].id
    when '31000000' #Durable goods
      industry_by_internal_name['durable-goods'].id
    when '32000000' #Nondurable goods
      industry_by_internal_name['nondurable-goods'].id
    when '40000000' #Trade, transportation, and utilities
      industry_by_internal_name['trade-transportation-and-utilities'].id
    when '42000000' #Retail trade
      industry_by_internal_name['retail-trade'].id
    when '43000000' #Transportation and warehousing
      industry_by_internal_name['transportation-and-warehousing'].id
    when '55000000' #Financial activities
      industry_by_internal_name['finance-and-insurance'].id
    when '60000000' #Professional and business services
      industry_by_internal_name['professional-scientific-and-technical-services'].id
    when '65000000' #Education and health services
      industry_by_internal_name['not-elsewhere-classified'].id
    when '70000000' #Leisure and recreation
      industry_by_internal_name['arts-entertainment-and-recreation'].id
    when '90000000'
      industry_by_internal_name['all-government'].id
    when '90910000'
      industry_by_internal_name['federal-government'].id
    when '90911000'
      industry_by_internal_name['federal-government-except-postal-service'].id
    when '90916220'
      industry_by_internal_name['federal-hospitals'].id
    when '90919110'
      industry_by_internal_name['department-of-defense'].id
    when '90919120'
      industry_by_internal_name['us-postal-service'].id
    when '90919999'
      industry_by_internal_name['not-elsewhere-classified'].id
    when '90920000'
      industry_by_internal_name['state-government'].id
    when '90921611'
      industry_by_internal_name['state-education'].id
    when '90922000'
      industry_by_internal_name['not-elsewhere-classified'].id
    when '90922622'
      industry_by_internal_name['state-hospitals'].id
    when '90922920'
      industry_by_internal_name['state-administration'].id
    when '90922999'
      industry_by_internal_name['not-elsewhere-classified'].id
    when '90930000'
      industry_by_internal_name['local-government'].id
    when '90931611'
      industry_by_internal_name['local-education'].id
    when '90932000'
      industry_by_internal_name['not-elsewhere-classified'].id
    when '90932221'
      industry_by_internal_name['local-utilities'].id
    when '90932480'
      industry_by_internal_name['local-transportation'].id
    when '90932622'
      industry_by_internal_name['local-hospitals'].id
    when '90932920'
      industry_by_internal_name['local-administration'].id
    when '90932999'
      industry_by_internal_name['not-elsewhere-classified'].id
    else
      naics = INDUSTRY[industrycode]
      if naics
...
employment, paid hours, and earnings information").first_or_create.id
  ...
  def import_series
    ...
    list = parsed_file.map do |series_id,  supersector_code,  industry_code, data_type_code,  seasonal,  series_title,  footnote_codes,  begin_year,  begin_period,  end_year,  end_period|
      ...
      industry_code_raw = INDUSTRY_RAW[industry_code]
  ...
  def update_industry
    ...
    parsed_file.each do |series_id,  supersector_code,  industry_code, data_type_code,  seasonal,  series_title,  footnote_codes,  begin_year,  begin_period,  end_year,  end_period|
      # puts industry_code + ' - ' + INDUSTRY[industry_code].to_s + ' - ' + industry_by_naics_code[INDUSTRY[industry_code].to_i].to_s + ' - ' + industry_id(industry_code).to_s + ' - ' + INDUSTRY_RAW[industry_code].to_s
      ser = Series.find_by(source_identifier: series_id.strip)
      if ser
        ser.industry_code_id = industry_id(industry_code)
        ser.industry_code_raw = INDUSTRY_RAW[industry_code].to_s
        ser.save
      else

...
SIZE_CLASS_ID_TO_DESCRIPTION = BLS_BD['size_class_id_to_description']
  ...
  def import_indicators
    ...
    Indicator.where(name: "Gross job gains", internal_name: 'gross_job_gains', description: "Gross job gains rounded to nearest thousand.", source_identifier: '11L', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Percent of gross job gains", internal_name: 'percent_of_gross_job_gains', description: "Percentage of jobs gained as a percent of total employment in the sector.", source_identifier: '11R', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Employment gained from expansions", internal_name: 'employment_gained_from_expansions', description: "Employment gained from expanding businesses rounded to nearest thousand.", source_identifier: '12L', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Percent of employment gained from expansions", internal_name: 'percent_of_employment_gained_from_expansions', description: "Percentage of employment gained from expanding businesses as a percentage of total employment in the sector", source_identifier: '12R', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Employment gained from openings", internal_name: 'employment_gained_from_openings', description: "Employment gained from new businesses rounded to nearest thousand. Openings include temporarily shut businesses that add staff.", source_identifier: '13L', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Percent of employment gained from openings", internal_name: 'percent_of_employment_gained_from_openings', description: "Percentage of employment gained from new businesses as a percentage of total employment in the sector. Openings include temporarily shut businesses that add staff.", source_identifier: '13R', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Gross job losses", internal_name: 'gross_job_losses', description: "Gross job losses rounded to nearest thousand.", source_identifier: '14L', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Percent of gross job losses", internal_name: 'percent_of_gross_job_losses', description: "Percentage of jobs lost as a percent of total employment in the sector.", source_identifier: '14R', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Employment lost from contractions", internal_name: 'employment_lost_from_contractions', description: "Employment lost from contracting businesses rounded to nearest thousand.", source_identifier: '15L', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Percent of employment lost from contractions", internal_name: 'percent_of_employment_lost_from_contractions', description: "Percent of employment lost from contracting businesses as a percentage of total employment in the sector", source_identifier: '15R', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    ...
    Indicator.where(name: "Percent of employment lost from closings", internal_name: 'percent_of_employment_lost_from_closings', description: "Percent of employment lost from closing businesses as a percentage of total employment in the sector. Closings include temporarily shut businesses that report zero staff.", source_identifier: '16R', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Employment gained by establishment births", internal_name: 'employment_gained_by_establishment_births', description: "Employment gained by establishment births rounded to nearest thousand. Births exclude temporarily shut businesses that add staff.", source_identifier: '17L', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Percent of employment gained by establishment births", internal_name: 'percent_of_employment_gained_by_establishment_births', description: "Percentage of employment gained by establishment births as a percentage of total employment in the sector. Births exclude temporarily shut businesses that add staff.", source_identifier: '17R', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Employment lost by establishment deaths", internal_name: 'employment_lost_by_establishment_deaths', description: "Employment lost by establishment deaths rounded to nearest thousand. Deaths exclude temporarily shut businesses that continue to report but have zero staff.", source_identifier: '18L', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Percent of employment lost by establishment deaths", internal_name: 'percent_of_employment_lost_by_establishment_deaths', description: "Percentage of employment lost by establishment deaths as a percentage of total employment in the sector. Deaths exclude temporarily shut businesses that continue to report but have zero staff.", source_identifier: '18R', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create

    Indicator.where(name: "Establishments with gross job gains", internal_name: 'establishments_with_gross_job_gains', description: "Number of establishments with gross job gains rounded to nearest thousand.", source_identifier: '21L', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Percent of establishments with gross job gains", internal_name: 'percent_of_establishments_with_gross_job_gains', description: "Percent of establishments with gross job gains in the sector.", source_identifier: '21R', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Establishments with employment gained from expansions", internal_name: 'establishments_with_employment_gained_from_expansions', description: "Number of establishments with employment gained from expansions rounded to nearest thousand.", source_identifier: '22L', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Percent of establishments with employment gained from expansions", internal_name: 'percent_of_establishments_with_employment_gained_from_expansions', description: "Percent of establishments with employment gained from expansions in the sector", source_identifier: '22R', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Establishments with employment gained from openings", internal_name: 'establishments_with_employment_gained_from_openings', description: "Number of establishments with employment gained from openings rounded to nearest thousand. Openings include temporarily shut businesses that add staff.", source_identifier: '23L', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Percent of establishments with employment gained from openings", internal_name: 'percent_of_establishments_with_employment_gained_from_openings', description: "Percent of establishments with employment gained from openings as a percentage of total employment in the sector. Openings include temporarily shut businesses that add staff.", source_identifier: '23R', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Establishments with gross job losses", internal_name: 'establishments_with_gross_job_losses', description: "Number of establishments with gross job losses rounded to nearest thousand.", source_identifier: '24L', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Percent of establishments with gross job losses", internal_name: 'percent_of_establishments_with_gross_job_losses', description: "Percent of establishments with gross job losses in the sector", source_identifier: '24R', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Establishments with employment lost from contractions", internal_name: 'establishments_with_employment_lost_from_contractions', description: "Number of establishments with employment lost from contractions rounded to nearest thousand.", source_identifier: '25L', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Percent of establishments with employment lost from contractions", internal_name: 'percent_of_establishments_with_employment_lost_from_contractions', description: "Percent of establishments with employment lost from contracting businesses as a percentage of the sector", source_identifier: '25R', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Establishments with employment lost from closings", internal_name: 'establishments_with_employment_lost_from_closings', description: "Number of establishments with employment lost from closing businesses rounded to nearest thousand. Closings include temporarily shut businesses that report zero staff.", source_identifier: '26L', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Percent of establishments with employment lost from closings", internal_name: 'percent_of_establishments_with_employment_lost_from_closings', description: "Percent of establishments with employment lost from closing businesses as a percentage of the sector. Closings include temporarily shut businesses that report zero staff.", source_identifier: '26R', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
    Indicator.where(name: "Establishment births", internal_name: 'establishment_births', description: "Number of establishment births. Births exclude temporarily shut businesses that add staff.", source_identifier: '27L', source_id: source_id, category_id: category_id, dataset_id: dataset_id).first_or_create
